...
<!--==================================================================================================================================================-->
                            <div class="row clearfix">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="int" name="Telefono" class="form-control" placeholder="Teléfono de la Empresa..." />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-8">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="Direccion"  class="form-control" placeholder="Dirección de la Empresa..." />
                                        </div>
                                    </div>
                                </div>
                            </div>
