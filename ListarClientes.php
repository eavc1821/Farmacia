                        ...
                        <div class="body table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                    <td><?php echo $filas['IdCli'] ?></td>
                                        <td><?php echo $filas['TelCli'] ?></td>
                                        <td><?php echo $filas['NomCli'] ?></td>
                                        <td><?php echo $filas['ApeCli'] ?></td>
                                        <td><?php echo $filas['DirCli'] ?></td>
                                        
                                        <td>
                                            <a type="button" href="ActualizarClient.php" class="btn bg-blue btn-circle waves-effect waves-circle waves-float">
