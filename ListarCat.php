                ...
                <div class="info-container">
                    ...
                    <div class="btn-group user-helper-dropdown">
                        ...
                        <ul class="dropdown-menu pull-right">
                            <li><a href="Configuraciones.php"><i class="material-icons">brightness_low</i>Mi Cuenta</a></li>
                        ...
                        <div class="body table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><?php echo $filas['NombreCat'] ?></td>
                                        <td>
                                            <a type="button" href="ActualizarCat.php?id=<?php echo $filas['IdCat'] ?>" class="btn bg-blue btn-circle waves-effect waves-circle waves-float">
                                   ...
                                   <!-- <tr>
                                        <td>Pastillas</td>
                                        <td>Todas las tables que existen</td>
                                        <td>
                                            <a type="button" href="ActualizarCat.html" class="btn bg-blue btn-circle waves-effect waves-circle waves-float">
                                                <i class="material-icons">autorenew</i>
                                            </a>
                                            <a type="button" href="#" class="btn bg-red btn-circle waves-effect waves-circle waves-float">
                                                <i class="material-icons">delete</i>
