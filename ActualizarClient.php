                            ...
                            <div class="row clearfix">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="Id" class="form-control" maxlength="10" placeholder="Cédula del Cliente..." />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="Telefono" class="form-control" maxlength="10" placeholder="Número de Celular / Teléfono..." />
                                        </div>
                                    </div>
                                </div>
