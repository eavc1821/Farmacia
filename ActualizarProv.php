...
$id=$_GET['id'];
$sql = "SELECT * FROM proveedores where IdProv = '$id'";
                    ...
                    <div class="card">
                        <div class="header">
                            <h2>
                                ...
                                <small>Registra cualquier proveedor en el sistema farmacéutico...</small>
                            </h2>
                        </div>
<!--==================================================================================================================================================-->
                        <div class="body">
                            ...
                            while ($filas=mysqli_fetch_array($resultado)){
                                ?>
                                    ...
                                    <input name="ID" hidden type="text" value="<?php echo $filas['IdProv'] ?>"/>
                                <div class="row clearfix">
                                <div class="col-sm-4">
                                ...
                                <div class="col-sm-8">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input name="Empresa" type="text" class="form-control" placeholder="Nombre de la Empresa..." value="<?php echo $filas['NomEmp'] ?>" />
                                        </div>
                                    </div>
                                </div>
                            </div>
<!--==================================================================================================================================================-->
                            <div class="row clearfix">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text"  name="Telefono" class="form-control" placeholder="Teléfono de la Empresa..." value="<?php echo $filas['TelEmp'] ?>" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-8">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text"  name="Direccion" class="form-control" placeholder="Dirección de la Empresa..." value="<?php echo $filas['DirEmpresa'] ?>" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                               ...
                               <!-- <div class="container-fluid" align="center">
                                ...
                                <div class="container-fluid" align="center">
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
                                        <a type="button" href="ListarProveed.php" class="btn bg-light-green"> VOLVER <i class="material-icons">call_missed_outgoing</i></a>
                                    </div>
