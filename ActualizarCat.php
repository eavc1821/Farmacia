                    ...
                    <div class="card">
                        <div class="header">
                            <h2>
                                ...
                                <small>Actualiza cualquier categoría de un producto farmacéutico...</small>
                            </h2>
                        </div>
<!--==================================================================================================================================================-->
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input name="Categoria" type="text" class="form-control" placeholder="Nombre de la Categoría..." value="<?php echo $filas['NombreCat'] ?>"/>
                                            <input name="ID" hidden type="text" value="<?php echo $filas['IdCat'] ?>"/>
                                        </div>
                                    </div>
                                </div>
 <!--==================================================================================================================================================-->
...
<!--==================================================================================================================================================-->
                               <!-- <div class="container-fluid" align="center">
                                 ...
                                 <div class="container-fluid" align="center">
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
                                        <a type="button" href="ListarCat.php" class="btn bg-light-green"> VOLVER <i class="material-icons">call_missed_outgoing</i></a>
                                    </div>
