...
<!--======================================================================================================-->
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="RegistrarClient.php">Registrar</a>
                            </li>
                            <li>
                    ...
                    <div class="card">
                        <div class="header">
                            <h2>
                                ...
                                <small>Registra cualquier trabajador dentro del sistema farmacéutico...</small>
                            </h2>
                        </div>
<!--==================================================================================================================================================-->
                        <div class="body">
                            <form action="ingresarPersonal.php" method="post">
                            <div class="row clearfix">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="Id" class="form-control"  placeholder="Cédula del Trabajador..." />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="Telefono" class="form-control"  placeholder="Número de Celular / Teléfono..." />
                                        </div>
                                    </div>
                                </div>
...
<!--==================================================================================================================================================-->
                            <div class="row clearfix">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="Nombres" class="form-control" placeholder="Nombres del Trabajador..." />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="Apellidos" class="form-control" placeholder="Apellidos del Trabajador..." />
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!--==================================================================================================================================================-->
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <textarea rows="4" name="Email" class="form-control no-resize" placeholder="E-mail..."></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
<!--==================================================================================================================================================-->
                               <!-- <div class="container-fluid" align="center">
                                ...
                                <div class="container-fluid" align="center">
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
                                    <input type="submit" value="Guardar" class="btn bg-green" > 
