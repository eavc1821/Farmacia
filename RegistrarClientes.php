                    ...
                    <div class="card">
                        <div class="header">
                            <h2>
                                ...
                                <small>Registra cualquier cliente dentro del sistema farmacéutico...</small>
                            </h2>
                        </div>
<!--==================================================================================================================================================-->
                        <div class="body">
                            <form action="ingresarClientes.php" method="post">
                            <div class="row clearfix">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="Id" class="form-control"  placeholder="Cédula del Cliente..." />
                                        </div>
                                    </div>
                                </div>
