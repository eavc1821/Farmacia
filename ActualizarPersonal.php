...
<!--======================================================================================================-->
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="RegistrarProveed.html">Registrar</a>
                            </li>
                            <li>
                    ...
                    <div class="card">
                        <div class="header">
                            <h2>
                                ...
                                <small>Actualizar cualquier cliente dentro del sistema farmacéutico...</small>
                            </h2>
                        </div>
<!--==================================================================================================================================================-->
                        <div class="body">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" name="Id" class="form-control" maxlength="13" minlength="13"  placeholder="Identidad" value="<?php echo $filas['IdPer'] ?>"/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" name="Telefono" class="form-control"  placeholder="Telefono" value="<?php echo $filas['TelPer'] ?>" />
                                </div>
                            </div>
                        </div>
...
<!--==================================================================================================================================================-->
                    <div class="row clearfix">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" name="Nombres" class="form-control" placeholder="Nombre" value="<?php echo $filas['NomPer'] ?>" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" name="Apellidos" class="form-control" placeholder="Apellido" value="<?php echo $filas['ApePer'] ?>" />
                                </div>
                            </div>
                        </div>
                    </div>
<!--==================================================================================================================================================-->
                        ...
                        <div class="form-group">
                            <div class="form-line">
                                <input type="text" name="Direccion" class="form-control" placeholder="Dirección" value="<?php echo $filas['DirPer'] ?>" />
                            </div>
                        </div>
...
<!--==================================================================================================================================================-->
                    ...
                    <div class="row clearfix">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <div class="form-line">
                                    <input name="Email" class="form-control no-resize" placeholder="Email" value="<?php echo $filas['Email'] ?>" />
                                </div>
                            </div>
                        </div>
                    </div>
<!--==================================================================================================================================================-->
                       <!-- <div class="container-fluid" align="center">
                        ...
                        <div class="container-fluid" align="center">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
                                <a type="button" href="ListarPersonal.php" class="btn bg-light-green"> VOLVER <i class="material-icons">call_missed_outgoing</i></a>
                            </div>
